...
# the warp spec loading has moved to get_warping_specs, please update the spec matching there
...
xr_warped.attrs['extraction_specs'] = json.dumps(extraction_specs) # also store the spec for reference

...
rule pycontrol_all:
    input: session2analyze(cohort=['2025_July_cohort','2025_June_cohort','2025_October_cohort','2025_September_cohort','2026_January_cohort','2026_April_cohort','2026_October_cohort'])
